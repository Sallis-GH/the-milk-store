  ...
  return (
    <div className='flex flex-col md:flex-row md:gap-20 md:justify-center'>
      ...
      <div className='flex flex-col gap-1'>
        ...
        <div className='mt-3'>
        <SlideBar currentValue={currentValue} setCurrentValue={setCurrentValue} storage={storage} />
        </div>
        <div className='flex h-full items-end'>
          <button
          onClick={() => alert(`${currentValue} liters of ${name} has been ordered.`)}
          className='h-8 bg-gray-100 cursor-pointer py-1 px-8 rounded-lg hover:bg-gray-50 active:scale-95 transition ease duration-[50ms]'>
            Order
          </button>
        </div>
      </div>
